class TurnosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @turno.update(turno_params)
        format.html { redirect_to @turno, notice: 'Turno se ha actualizado correctamente.' }
  ...
  def destroy
    @turno.destroy
    respond_to do |format|
      format.html { redirect_to turnos_url, notice: 'Turno se ha eliminado correctamente.' }
